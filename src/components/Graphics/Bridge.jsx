...
export const Bridge = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3877.3 2610.2" {...props}>
      ...
      <circle className={styles.streetlight} fill="url(#streetlight-gradient)" cx="200" cy="190" r="18"><animate attributeName="r" values="18;20;18" dur="3s" repeatCount="indefinite" /></circle>
      <circle className={styles.streetlight} fill="url(#streetlight-gradient)" cx="600" cy="210" r="18"><animate attributeName="r" values="18;16;18" dur="3s" repeatCount="indefinite" /></circle>
      <circle className={styles.streetlight} fill="url(#streetlight-gradient)" cx="1000" cy="90" r="18"><animate attributeName="r" values="18;20;18" dur="3s" repeatCount="indefinite" /></circle>
      <circle className={styles.streetlight} fill="url(#streetlight-gradient)" cx="1400" cy="135" r="18"><animate attributeName="r" values="18;16;18" dur="3s" repeatCount="indefinite" /></circle>
      <circle className={styles.streetlight} fill="url(#streetlight-gradient)" cx="1800" cy="50" r="18"><animate attributeName="r" values="18;20;18" dur="3s" repeatCount="indefinite" /></circle>
      <circle className={styles.streetlight} fill="url(#streetlight-gradient)" cx="2200" cy="110" r="18"><animate attributeName="r" values="18;16;18" dur="3s" repeatCount="indefinite" /></circle>
      <circle className={styles.streetlight} fill="url(#streetlight-gradient)" cx="2600" cy="50" r="18"><animate attributeName="r" values="18;20;18" dur="3s" repeatCount="indefinite" /></circle>
      <circle className={styles.streetlight} fill="url(#streetlight-gradient)" cx="3000" cy="135" r="18"><animate attributeName="r" values="18;16;18" dur="3s" repeatCount="indefinite" /></circle>
      <circle className={styles.streetlight} fill="url(#streetlight-gradient)" cx="3400" cy="130" r="18"><animate attributeName="r" values="18;20;18" dur="3s" repeatCount="indefinite" /></circle>
      <circle className={styles.streetlight} fill="url(#streetlight-gradient)" cx="3800" cy="240" r="18"><animate attributeName="r" values="18;16;18" dur="3s" repeatCount="indefinite" /></circle>
